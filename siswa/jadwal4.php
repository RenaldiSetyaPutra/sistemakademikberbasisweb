          ...
          <div class="m-10 2-8 x2-6 center">
            <div class="margin">
				<table bgcolor="#454545" width="1000" border="1">
				  <tr>
					<th width="250"><div align="center">Mapel</div></th>
					<th width="250"><div align="center">Guru</div></th>
					<th width="250"><div align="center">Hari</div></th>
					<th width="250"><div align="center">Jam</div></th>
				  </tr>				  
				<?php
					include 'koneksi.php';
					$nis = $_SESSION['kode_user'];
					$query = "SELECT guru, mapel, hari, jam FROM jadwal where Kelas = (Select kelas from siswa where nis='$nis')";
					$exec = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
					while($data = mysqli_fetch_array($exec)){
						echo 
						'
						<tr>
						<td width="250"><div align="center">'.$data['mapel'].'</div></td>
						<td width="250"><div align="center">'.$data['guru'].'</div></td>
						<td width="250"><div align="center">'.$data['hari'].'</div></td>
						<td width="250"><div align="center">'.$data['jam'].'</div></td>
					  </tr>
