        ...
        <div class="top-nav"> 
          ...
          <div class="top-nav left-menu">
             <ul class="center top-ul chevron">
				...
				<li><a href="select_kelas.php">Kelas</a></li>
				<li><a href="jadwal4.php">Jadwal Pelajaran</a></li>
				<li><a href="select_khs.php">KHS</a></li>
            ...
            <div class="margin">
				...
				<form method='post' action='update_biodata.php'>
					<table bgcolor="#454545" width="400" border="1">
					 <tr>
						<td><input type='hidden' name='nis' value='<?php echo $data['nis'] ?>'><p></td>
					  </tr>
					   <tr>
						<td>Nama</td>
						<td>:</td>
