          ...
          <div class="m-10 l-6 xl-4 center">
            <div class="margin">
				<?php
					...
					$query = "SELECT nama_siswa, kelas FROM siswa where kelas = (Select kelas from siswa where nis='$nis') order by nama_siswa";
					$exec = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
					echo
					'
					<table width="434" border="1">
					<tr>
						<th width="220" scope="col">Nama Siswa</th>
						<th width="59" scope="col">Kelas</th>
					  </tr>
					  </table>
					 '; 
					while($data = mysqli_fetch_array($exec)){
						...
						'<table width="434" border="1">
					  <tr>
						<td width ="220">'.$data['nama_siswa'].'</td>
						<td width ="59">'.$data['kelas'].'</td>
					  </tr>
					</table>
					';
				}
