          ...
          <div class="m-10 l-6 xl-4 center">
            <div class="margin">
				<?php
					...
					$query = "SELECT nis, nama_siswa, jenis_kelamin, tempat_lahir, tanggal_lahir, agama, alamat, no_telp, email, status_aktif FROM siswa where nis = '$kode_user'";
					...
					while($data = mysqli_fetch_array($exec)){
					  ...
					  <tr>
						<td><a href="form_update_biodata.php"?nis='.$data['nis'].'"><button>Ubah</button></a></td>
					  </tr>
					</table>';
					}
				?>
