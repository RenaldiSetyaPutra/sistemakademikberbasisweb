          ...
          <div class="m-10 l-6 xl-4 center">
            <div class="margin">
				<?php
					...
					$query = "SELECT nip, nama_guru, jenis_kelamin, tempat_lahir, tanggal_lahir, agama, alamat, no_telp, email, status_aktif FROM guru where nip = '$kode_user'";
					...
					while($data = mysqli_fetch_array($exec)){
					  ...
					  <tr>
						<td><a href="form_update_biodata.php"?nis='.$data['nip'].'"><button>Edit</button></a></td>
					  </tr>
					</table>';
					}
				?>
