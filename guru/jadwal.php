            ...
            <div class="margin">
				<table bgcolor="#454545" width="1000" border="1">
				  <tr>
					...
					<th width="250"><div align="center">Kelas</div></th>
					...
					$query = "SELECT guru, kelas, hari, jam FROM jadwal where guru = (Select nama_guru from guru where nip='$nip') order by kelas";
					...
					while($data = mysqli_fetch_array($exec)){
						...
						<td width="250"><div align="center">'.$data['kelas'].'</div></td>
