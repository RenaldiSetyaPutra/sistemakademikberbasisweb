  ...
  <body class="size-1280">
	...
	<h4 class="text-extra-thin text-white text-s-size-20 text-m-size-20 text-size-20 text-line-height-1 margin-bottom-40 margin-top-80">Selamat Datang, <?php echo $_SESSION['nama_user']; ?>!</h4>
      ...
      <section class="section-small-padding background-dark text-center">  
		 <div class="line">
          <div class="m-10 2-8 x2-6 center">
            <div class="margin">
				<table bgcolor="#454545" width="650" border="1">
				  <tr>
					<td width="150"><div align="center">NIS</div></td>
					<td width="200"><div align="center">Nama Siswa</div></td>
					<td width="100"><div align="center">Kelas</div></td>
					<td colspan ="3" width="200"><div align="center">Keterangan</div></td>
				  </tr>
				<?php
					include 'koneksi.php';
					$query = "SELECT nama_siswa, nis, kelas FROM siswa where kelas ='4' order by nama_siswa";
					$exec = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
					while($data = mysqli_fetch_array($exec)){
						echo 
						'
						<tr>
						<td width="150"><div align="center">'.$data['nis'].'</div></td>
						<td width="200"><div align="center">'.$data['nama_siswa'].'</div></td>
						<td width="100"><div align="center">'.$data['kelas'].'</div></td>
						<td width="65"><label><input type="radio" name="RadioGroup1" value="hadir" id="hadir"/>Hadir</label></td>
						<td width="65"><label><input type="radio" name="RadioGroup1" value="sakit" id="sakit"/>Sakit</label></td>
						<td width="65"><label><input type="radio" name="RadioGroup1" value="alpa" id="alpa"/>Alpa</label></td>
					  </tr>
					';
					}
					?>
				...
				<?php
				echo  '<a href="insert_absen.php"><button>Simpan</button></a>'
				?>
	</section>
    <!-- FOOTER -->
    <footer>
