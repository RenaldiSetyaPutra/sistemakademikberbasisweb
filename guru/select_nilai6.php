      ...
      <section class="section-small-padding background-dark text-center">  
            <div class="margin">
					...
					<table bgcolor="#454545"  border="1">
						<tr>
							<th widht="50">NIS</th>
							<th widht="50">Nama Siswa</th>
							<th widht="50">Kelas</th>
							<th widht="50">Pelajaran</th>
							<th widht="50">Tugas</th>
							<th widht="50">Absen</th>
							<th widht="50">Attitude</th>
							<th widht="50">UTS</th>
							<th widht="50">UAS</th>
							<th widht="50">Nilai Akhir</th>
							<th widht="50">Grade</th>
						</tr>
					<?php
					include 'koneksi.php';
					$query = "SELECT nis, nama_siswa, kelas, mapel, tugas, absen, attitude, uts, uas, nilai_akhir, grade FROM nilai where kelas='6' order by nama_siswa";
					$exec = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
					while($data = mysqli_fetch_array($exec)){
						echo '
							  <tr>
								<td widht="50">'.$data['nis'].'</td>
								...
								<td><a href="delete_nilai.php?nis='.$data['nis'].'"><button>Del</button></a></td>
							  </tr>
							  ';
					}
				?>
							...
							<?php
								echo '<a href="form_nilai.php"><button>Tambah</button></a>'
							?>
        </div>
