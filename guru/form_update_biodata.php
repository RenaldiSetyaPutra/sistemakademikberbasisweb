        ...
        <div class="top-nav"> 
          ...
          <div class="top-nav left-menu">
             <ul class="center top-ul chevron">
				...
				<li><a href="form_nilai.php">Penilaian Siswa</a></li>
            ...
            <div class="margin">
				...
				<form method='post' action='update_biodata.php'>
					<table bgcolor="#454545" width="400" border="1">
					  <tr>
						<td><input type='hidden' name='nip' value='<?php echo $data['nip'] ?>'><p></td>
					  </tr>
					   <tr>
						<td>Nama</td>
						<td>:</td>
						<td><input type='text' name='nama_guru' value='<?php echo $data['nama_guru'] ?>'><p></td>
					  </tr>
					  <tr>
					  <tr>
						<td>Jenis Kelamin</td>
						<td>:</td>
						<td><input type='text' name='jenis_kelamin' value='<?php echo $data['jenis_kelamin'] ?>'><p></td>
					  </tr>
					  <tr>
						<td>Tempat Lahir</td>
						<td>:</td>
						<td><input type='text' name='tempat_lahir' value='<?php echo $data['tempat_lahir'] ?>'><p></td>
					  </tr>
					  <tr>
						<td>Tanggal Lahir</td>
						<td>:</td>
						<td><input type='text' name='tanggal_lahir' value='<?php echo $data['tanggal_lahir'] ?>'><p></td>
					  </tr>
					  <tr>
						<td>Agama</td>
						<td>:</td>
						<td><input type='text' name='agama' value='<?php echo $data['agama'] ?>'><p></td>
					  </tr>
					  <tr>
						<td>Alamat</td>
						<td>:</td>
						<td><input type='text' name='alamat' value='<?php echo $data['alamat'] ?>'><p></td>
					  </tr>
					  <tr>
						<td>No Telepon</td>
						<td>:</td>
						<td><input type='text' name='no_telp' value='<?php echo $data['no_telp'] ?>'><p></td>
					  </tr>
					  <tr>
						<td>Email</td>
						<td>:</td>
						<td><input type='text' name='email' value='<?php echo $data['email'] ?>'><p></td>
					  </tr>
					  <tr>
						<td>Status Aktif</td>
						<td>:</td>
						<td><input type='text' name='status_aktif' value='<?php echo $data['status_aktif'] ?>'><p></td>
					  </tr>
					  <tr>
